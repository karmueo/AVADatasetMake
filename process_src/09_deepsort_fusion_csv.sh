...
~/work/anaconda/bin/python ./process_src/yolovDeepsort/yolov5_to_deepsort.py
echo "ok. 完成人物ID检测"

# 融合人ID&action		（train_personID.csv && train_without_personID.csv -- train_temp.csv）
~/work/anaconda/bin/python ./process_src/train_temp.py

# 修正csv的-1值		（train_temp.csv -- ./annotations/train.csv）
~/work/anaconda/bin/python ./process_src/train.py
