...
~/work/anaconda/bin/python ./process_src/dense_proposals_train_to_via.py ./process_file/dense_proposals_train.pkl ./process_file/choose_frames_middle/
echo "ok. 第一次导出via n_proposal.json"

# 去除via默认值		（choose_frames_middle/_proposal.json -- _proposal_s.json）
~/work/anaconda/bin/python ./process_src/changs_via_json.py ./process_file/choose_frames_middle
...
~/work/anaconda/bin/python ./process_src/change_dense_proposals_train.py ${OUT_PKL_DIR}/dense_proposals_train.pkl
